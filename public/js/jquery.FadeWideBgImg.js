		...
		$.fn.FadeWideBgImg = function (options){
			...
			var $ShowTarget = $('li',_this),
				...
				$('.fwb-loading').css({
					...
					'color' : '#d9d9d9',
					'text-align' : 'center',
					'line-height' : setValue.minheight+'px',
			...
			function verticalCenter(){
				...
				$.each($ShowTargetImg, function() {
					$(this).parent("li").css({
						'margin-top' : (setValue.minheight-$(this).height())/2
					});			  				
