        ...
        var draw = function () {
            ...
            for (var i = 0; i < nDates; i++) {
                ...
                for (var j = 0; j < nDate; j++) {
                    ...
                    var colDate = "<td id='calendarClick" + year + "-" + month + "-" + date + "' class='" + colDateClass + " " + ((showCalendarClick == true) ? 'calendarClick' : '') + "' data-date='" + date + "' data-month='" + month + "' data-year='" + year + "'><div class='entry' onclick='navi()' id='nav" + year + "-" + month + "-" + date + "'>" + date + "</div></td>";
